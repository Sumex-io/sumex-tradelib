...
var (
	tradeName_Spot    = "WEEX_SPOT"
	tradeName_Futures = "WEEX_FUTURES"
)
...
func NewSpotClient(apiKey, secretKey, passphrase string) *SpotClient {
	return &SpotClient{
		apiKey:     apiKey,
		secretKey:  secretKey,
		passphrase: passphrase,
		keyType:    utils.KeyTypeHmacBase64,
...
func NewFuturesClient(apiKey, secretKey, passphrase string) *FuturesClient {
